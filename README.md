...
- Analyze customer churn pattern
- Identify the key factors that influencing customer churn
- Segment customer based on the demographic, behavioral and financial characteristics
- Evaluate customer risk levels to prioritize retention efforts.
